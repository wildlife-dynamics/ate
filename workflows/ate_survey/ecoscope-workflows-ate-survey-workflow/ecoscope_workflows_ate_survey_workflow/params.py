...
class MapPartAge(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    column_name: str = Field(
        ..., description="The column name to map.", title="Column Name"
    )
...
class MapPartAgeGroup(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    column_name: str = Field(
...
class MapOpinionEleCol(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    column_name: str = Field(
...
class MapReactColumn(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    column_name: str = Field(
...
class MapMaritalStatus(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class Params(BaseModel):
    ...
    map_part_age: Optional[MapPartAge] = Field(None, title="Map participant age column")
    map_house_size: Optional[MapHouseSize] = Field(
        None, title="Map household size column"
    )
    map_pat_tribe: Optional[MapPatTribe] = Field(None, title="Map participant tribe")
    map_part_gender: Optional[MapPartGender] = Field(
        None, title="Map participant gender"
    )
    map_part_age_group: Optional[MapPartAgeGroup] = Field(
        None, title="Map participant age group"
    )
    map_years_lived: Optional[MapYearsLived] = Field(
        None, title="Map years living in area"
    )
    map_overall_col: Optional[MapOverallCol] = Field(
        None, title="Map overall feelings about wildlife"
    )
    map_opinion_ele_col: Optional[MapOpinionEleCol] = Field(
        None, title="Map opinions on having elephants in the area"
    )
    map_how_often: Optional[MapHowOften] = Field(
        None, title="Map How often seen elephants in the last year"
    )
    map_what_foot: Optional[MapWhatFoot] = Field(
        None, title="Map What do you do when you encounter elephants on foot"
    )
    map_react_column: Optional[MapReactColumn] = Field(
        None, title="Map Reaction to hearing about elephants being harmed"
    )
    map_high_ed_col: Optional[MapHighEdCol] = Field(
        None, title="Map Highest level of education"
    )
    map_threat_col: Optional[MapThreatCol] = Field(
        None, title="Map Greatest threat to your livestock"
    )
    map_crop_threat: Optional[MapCropThreat] = Field(
        None, title="Map Greatest threat to crop production"
    )
    map_future_col: Optional[MapFutureCol] = Field(
        None, title="Map Which intervention would help you in future"
    )
    map_marital_status: Optional[MapMaritalStatus] = Field(
        None, title="Map Marital status"
    )
    map_land_tenure: Optional[MapLandTenure] = Field(None, title="Map Land tenure")
