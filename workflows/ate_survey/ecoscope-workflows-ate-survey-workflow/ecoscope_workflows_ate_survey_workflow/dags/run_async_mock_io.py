...
def main(params: Params):
    ...
    dependencies = {
        ...
        "filter_elephant_qs": ["bin_survey_cols"],
        ...
        "apply_ov_colormap": ["remove_geom_ov_outliers"],
        "generate_ov_layers": ["apply_ov_colormap"],
        "combine_ov_map_layers": ["create_custom_map_layers", "generate_ov_layers"],
        "zoom_ov_layers": ["apply_ov_colormap"],
        "draw_ov_ecomap": [
            "configure_base_maps",
            "zoom_ov_layers",
    ...
    nodes = {
        ...
        "download_ate_tpt": Node(
            ...
            .set_executor("lithops"),
            partial={
                "url": "https://www.dropbox.com/scl/fi/nyexeyppis60v6p9wmiu3/ate_survey_template_updated.docx?rlkey=mgcln0f6ncjtzk9eeyipdo145&st=p7oiz0zm&dl=0",
        ...
        "filter_elephant_qs": Node(
            async_task=filter_cols_df.validate()
        ...
        "zoom_att_layers": Node(
            ...
            partial={
                "pitch": 0,
                "bearing": 0,
                "gdf": DependsOn("apply_att_colormap"),
            }
        ...
        "zoom_gn_layers": Node(
            ...
            partial={
                "pitch": 0,
                "bearing": 0,
                "gdf": DependsOn("apply_gn_colormap"),
            }
        ...
        "apply_ov_colormap": Node(
            ...
            partial={
                ...
                "colormap": ["#C70039"],
                "df": DependsOn("remove_geom_ov_outliers"),
            }
        ...
        "generate_ov_layers": Node(
            ...
            partial={
                ...
                "geodataframe": DependsOn("apply_ov_colormap"),
            }
        ...
        "zoom_ov_layers": Node(
            ...
            partial={
                "pitch": 0,
                "bearing": 0,
                "gdf": DependsOn("apply_ov_colormap"),
            }
        ...
        "convt_ecohtml_png": Node(
            ...
            partial={
                "html_path": DependsOnSequence(
                    [
                        DependsOn("persist_att_ecomap_urls"),
                        DependsOn("persist_gn_ecomap_urls"),
                        DependsOn("persist_ov_ecomap_urls"),
